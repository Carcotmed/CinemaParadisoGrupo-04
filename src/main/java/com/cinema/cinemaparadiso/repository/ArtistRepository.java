...
public interface ArtistRepository extends CrudRepository<Artist,Integer>{
	...
	@Query("SELECT project FROM Project project INNER JOIN Rel_projects_artists rel_projects_artists ON project.id = rel_projects_artists.artist_id AND rel_projects_artists.artist_id = :artistId")
