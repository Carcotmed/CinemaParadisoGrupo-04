...
INSERT INTO writers (id,version, description, name, sur_name, photo, username) VALUES (1,0,'Aficionado a la escritura desde que era pequeños','Rebecca','Bullock','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXLauXHp8NfrusbSPOfujsPJgxe6KIgQjiVw&usqp=CAU','GradyManning');
...
INSERT INTO writers (id,version, description, name, sur_name, photo, username) VALUES (2,0,'Aficionado a la escritura desde que era pequeños','Libby','Vaughan','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXLauXHp8NfrusbSPOfujsPJgxe6KIgQjiVw&usqp=CAU','KyleConway');
