...
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request) VALUES (1,0,'Test Issue 1','Test Body 1',DATE('2021/04/10', 'YYYY/MM/DD'),'autoCreatedTestUser3','autoCreatedTestUser4',false);
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request) VALUES (2,0,'Test Issue 2','Test Body 2',DATE('2021/04/10', 'YYYY/MM/DD'),'autoCreatedTestUser3','autoCreatedTestUser4',false);

INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request) VALUES (3,0,'Test Issue To Delete','Test Body To Delete',DATE('2021/04/10', 'YYYY/MM/DD'),'autoCreatedTestUser1','autoCreatedTestUser2',false);
...
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request) VALUES (4,0,'Quiero unirme a su proyecto','Me gustaría entrar en su proyecto llamado Producciones Sevilla. Mi rol es CAMARA.',DATE('2021/04/10', 'YYYY/MM/DD'),'autoCreatedTestUser2','autoCreatedTestUser2',1);
...
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request) VALUES (5,0,'Quiero unirme a su proyecto','Me gustaría entrar en su proyecto llamado Producciones Sevilla. Mi rol es Productor.',DATE('2021/04/10', 'YYYY/MM/DD'),'autoCreatedTestUser5','autoCreatedTestUser2',1);
...
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request,story_id) VALUES (6,0,'asd','asddassadsadasdasdads',DATE('2021/04/10', 'YYYY/MM/DD'),'autoCreatedTestUser2','autoCreatedTestUser2',1,1);
...
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request) VALUES (7,0,'asd','asdasdasdasdasdasd',DATE('2021/04/10', 'YYYY/MM/DD'),'autoCreatedTestUser7','autoCreatedTestUser2',1);
...
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request) VALUES (8,0,'asd','asdasdasdasdasd',DATE('2021/04/10', 'YYYY/MM/DD'),'autoCreatedTestUser8','autoCreatedTestUser2',1);
...
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request) VALUES (9,0,'asd','Test Created Body 1',DATE('2021/04/10', 'YYYY/MM/DD'),'userWithMessages1','userWithMessages2',1);
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request) VALUES (10,0,'asd','Test Created Body 2',DATE('2021/04/10', 'YYYY/MM/DD'),'userWithMessages1','userWithMessages2',1);
...
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request, story_id, seen) VALUES (11,0,'asd','Test Created Body 3',DATE('2021/04/10', 'YYYY/MM/DD'),'userWithMessages3','userWithMessages4',1,2, false);
INSERT INTO messages (id,version,issue, body, messagedate, emisor_id, receptor_id,is_request, story_id, seen) VALUES (12,0,'asd','Test Created Body 4',DATE('2021/04/10', 'YYYY/MM/DD'),'userWithMessages3','userWithMessages4',1,2, true);
