...
INSERT INTO artists (id,description,name,sur_name,pro,summary,username,role,photo,version) VALUES (1,'pepitod','pepito1','pepito1sur',TRUE,'pepito1sum','admin0','CAMARA','https://i.blogs.es/5efe2c/cap_001/450_1000.jpg',0);
INSERT INTO artists (id,description,name,sur_name,pro,summary,username,role,photo,version) VALUES (2,'pepito2d','pepito2','pepito2sur',TRUE,'pepito2sum','admin1','DIRECTOR','https://empresas.blogthinkbig.com/wp-content/uploads/2019/11/Imagen3-245003649.jpg?w=800',0);
INSERT INTO artists (id,description,name,sur_name,pro,summary,username,role,photo,version) VALUES (3,'pepito3d','pepito3','pepito3sur',FALSE,'pepito3sum','admin2','GUIONISTA','https://e00-marca.uecdn.es/assets/multimedia/imagenes/2020/04/08/15863374252712.jpg',0);
INSERT INTO artists (id,description,name,sur_name,pro,summary,username,role,photo,version) VALUES (4,'pepito4d','pepito4','pepito4sur',FALSE,'pepito4sum','admin3','ACTOR','https://3.bp.blogspot.com/-JfL1o7oSnKI/VmodObHF9cI/AAAAAAAABLY/nKKRXw0-yiU/s1600/homero_456_336.jpg',0);
INSERT INTO artists (id,description,name,sur_name,pro,summary,username,role,photo,version) VALUES (5,'juanitod','juanito1','juanito1sur',TRUE,'juanito1sum','admin4','CAMARA','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS3pGX4MsvahQ6lazFvLB5q5gM1hutnF_erdg&usqp=CAU',0);
INSERT INTO artists (id,description,name,sur_name,pro,summary,username,role,photo,version) VALUES (6,'juanito2d','juanito2','juanito2sur',TRUE,'juanito2sum','admin5','DIRECTOR','https://cdn.shopify.com/s/files/1/0229/0839/files/Busqueda_de_imagenes_3_large.jpg?v=1578328497',0);
INSERT INTO artists (id,description,name,sur_name,pro,summary,username,role,photo,version) VALUES (7,'juanito3d','juanito3','juanito3sur',FALSE,'juanito3sum','admin6','GUIONISTA','https://imagenes.milenio.com/frnpuakaet1zMB01a5O8Fl9YbRk=/958x596/https://www.milenio.com/uploads/media/2020/06/26/la-imagen-completa-esta-mas-2_0_167_319_198.jpg',0);
INSERT INTO artists (id,description,name,sur_name,pro,summary,username,role,photo,version) VALUES (8,'juanito4d','juanito4','juanito4sur',FALSE,'juanito4sum','admin7','ACTOR','https://dam.ngenespanol.com/wp-content/uploads/2019/03/luna-colores-nuevo.png',0);
