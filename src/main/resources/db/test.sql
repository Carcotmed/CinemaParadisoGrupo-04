...
INSERT INTO producers(version,name,sur_Name,nif, description, username) VALUES ('0','Christopher','Nolan','12345678D','Productor exitoso y feliz con ganas de trabajar con un equipo de trabajo apasionado por el cine de terror', 'adminTest');
INSERT INTO producers(version,name,sur_Name,nif, description, username) VALUES ('0','Woody','Allen','19876543W','Productor con larga experiencia en películas de ciencia ficción', 'ivanlot');
INSERT INTO producers(version,name,sur_Name,nif, description, username) VALUES ('0','Mel','Gibson','34587666Y','Productora con ganas de realizar un cortometraje acerca del covid y su repercusión en la vida de las personas','user');
