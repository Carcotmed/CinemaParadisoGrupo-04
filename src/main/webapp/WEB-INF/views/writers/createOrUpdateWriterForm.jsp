...
<body class="h-100" style="background-color: #272727; color: white">
	<div class="d-flex justify-content-center align-items-center"
		...
		<div class="d-flex justify-content-between" style="width: 40%;">
			...
			<form:form method="POST" action="create" modelAttribute="writer"
				style="width:100%">
				<!--  USUARIO -->
                     <div class="d-flex justify-content-between align-items-center" style="margin:1% 0">
							...
							<form:input class="form-control" value="${writer.user.username}" placeholder="Usuario" style="margin-left: 3%;width:60%" type="text" path="user.username"></form:input>
						</div>
						...
						<div class="d-flex justify-content-between align-items-center" style="margin:1% 0">
							...
							<form:input class="form-control" value="${writer.user.password}" placeholder="Clave" style="margin-left: 3%;width:60%" type="password" path="user.password"></form:input>
						</div>
				...
				<div class="d-flex justify-content-between align-items-center" style="margin:1% 0">
							...
							<form:input class="form-control" value="${writer.user.email}" placeholder="example@example.com" style="margin-left: 3%;width:60%" type="text" path="user.email"></form:input>
						</div>
				...
				<div>
					...
					<div class="d-flex justify-content-between align-items-center"
						...
						<div class="d-flex flex-wrap ">
							<form:label class="p-2 rounded-pill form-control-label"
								style="background-color:#828282" path="photo">A�ade tu foto</form:label>
						</div>
