...
<body>
	...
	<div class="padding-nav padding-footer d-flex justify-content-center align-items-center">
		...
		<div class="form-wrapper">
			<h3>Crear escritor</h3>
	
			<form:form method="POST" action="create" modelAttribute="writer" style="width:100%" enctype="multipart/form-data">
                <div class="d-flex justify-content-between align-items-center">
					<form:label class="rounded-pill form-control-label" path="user.username">Usuario</form:label>
					<form:input class="form-control" value="${writer.user.username}" placeholder="Usuario" type="text" path="user.username"></form:input>
				</div>
				...
				<div class="d-flex justify-content-between align-items-center">
					...
					<form:input class="form-control" value="${writer.user.password}" placeholder="Clave" type="password" path="user.password"></form:input>
				</div>
				...
				<div class="d-flex justify-content-between align-items-center">
					...
					<form:input class="form-control" value="${writer.user.email}" placeholder="example@example.com" type="text" path="user.email"></form:input>
				</div>
				...
				<div id="photoA" class="d-flex justify-content-between align-items-center">
					...
					<form:input onchange="photoChanged(value)" class="form-control" value="${writer.photo}"
