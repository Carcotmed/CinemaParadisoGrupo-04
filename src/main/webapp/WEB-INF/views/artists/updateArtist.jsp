	...
	<div class="d-flex justify-content-center align-items-center" style="padding:2%">
		...
		<!-- Info general Proyecto -->
			...
			<div class="d-flex justify-content-between" style="width:40%;">
				...
				<form:form method="POST" action="${artist.id}" modelAttribute="artist" style="width:100%">
					...
					<br>
					<a href="/artists/show/${artist.id}" style="color:white;height: fit-content;background-color:#af3248" class="btn rounded-pill">Volver</a>
				</form:form>
			</div>
