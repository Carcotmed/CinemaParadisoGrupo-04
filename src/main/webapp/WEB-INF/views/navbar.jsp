...
<!DOCTYPE html>
	<div style="padding:0.5%;background-color:#2b2b2b;z-index:99;top:0" class="position-sticky d-flex justify-content-between align-items-center w-100">
		...
		<div style="width: 13%;margin-right:1%" class="d-flex justify-content-end align-items-center">
			...
			<sec:authorize access="!isAuthenticated()">
					<li><a href="<c:url value="/login" />" style="margin: 0 9%;color:white;background-color:#af3248" class="btn rounded-pill">Inicia sesi�n</a></li>
			...
			<sec:authorize access="isAuthenticated()">
			<li><a href="<c:url value="/logout" />" style="margin: 0 5%;color:white; background-color:#af3248" class="btn rounded-pill">Cerrar sesi�n</a></li>
