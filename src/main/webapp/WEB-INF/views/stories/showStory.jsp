			...
			<c:if test="${ comments.size()!=0 }">
				<div style="height: 16rem; overflow-y: scroll">
					<div>
						...
						<div style="width: 12rem; border-radius: 1rem; background-color: #575758; padding: 0.2rem 0.7rem 0.2rem 0.7rem"><a style="color: white; text-decoration: none;" href="/users/showUser/${ comment.comment.username }/${story.id}">${ comment.comment.username }</a></div>-->
						...
						<c:if test="${comment.answers!=null}">
							<div style="font-size: 0.7rem">
								<c:forEach items="${ comment.answers }" var="answer">
									...
									<div style="width: 8.9rem; border-radius: 1rem; background-color: #575758; padding: 0.2rem 0.7rem 0.2rem 0.7rem"><a style="color: white; text-decoration: none;" href="/users/showUser/${ answer.username }/${story.id}">${ answer.username }</a></div>-->
