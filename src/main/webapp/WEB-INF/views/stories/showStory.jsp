	...
	<div id="modalProyectos"
		...
		<c:forEach items="${projects}" var="projects">
			...
			<div class="d-flex justify-content-between align-items-center">
				...
				<button class="btn rounded-pill" onClick="location.href='/stories/request/${story.id}/${projects.id}'"
	...
	<div class="d-flex justify-content-between p-3" style="height:15%">
		...
		<c:if test="${showButton == false}">
			<sec:authorize access="isAuthenticated()">
				<button class="btn rounded-pill" onClick="location.href='/messages/create/${writerUsername}'"
					style="color:white;height: fit-content;background-color: #af3248">Contactar con el escritor</button>
				<button class="btn rounded-pill" id="levantaModal"
					style="color:white;height: fit-content;background-color: #af3248">Asociar proyecto</button>
			</sec:authorize>
			<c:choose>
				<c:when test="${showButton == true}">
					<button class="btn rounded-pill" onClick="location.href='/stories/update/${story.id}'"
						style="color:white;height: fit-content;background-color: #af3248">Actualizar</button>
		...
		<c:if test="${showButton == true}">
			...
			<button class="btn rounded-pill" onClick="location.href='/stories/delete/${story.id}'"
